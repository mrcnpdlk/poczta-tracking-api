...
/**
 * This class stands for sprawdzPrzesylki StructType
 */
class SprawdzPrzesylki extends AbstractStructBase
{
    /**
     * The numer
    ...
    /**
     * Constructor method for sprawdzPrzesylki
     *
     * @uses SprawdzPrzesylki::setNumer()
     *
     * @param string[] $numer
     */
    ...
    public static function validateNumerForArrayConstraintsFromSetNumer(array $values = [])
    {
        $message       = '';
        $invalidValues = [];
        foreach ($values as $sprawdzPrzesylkiNumerItem) {
            // validation for constraint: itemType
            if (!is_string($sprawdzPrzesylkiNumerItem)) {
                $invalidValues[] = is_object($sprawdzPrzesylkiNumerItem) ? get_class($sprawdzPrzesylkiNumerItem) : sprintf('%s(%s)', gettype($sprawdzPrzesylkiNumerItem), var_export($sprawdzPrzesylkiNumerItem, true));
            }
        }
     ...
     *
     * @return \Mrcnpdlk\Api\PocztaTracking\Sdk\StructType\SprawdzPrzesylki
     */
