...
/**
 * This class stands for sprawdzPrzesylkiOdDoPl StructType
 */
class SprawdzPrzesylkiOdDoPl extends AbstractStructBase
{
    /**
     * The numer
    ...
    /**
     * Constructor method for sprawdzPrzesylkiOdDoPl
     *
     * @uses SprawdzPrzesylkiOdDoPl::setNumer()
     * @uses SprawdzPrzesylkiOdDoPl::setOdDnia()
     * @uses SprawdzPrzesylkiOdDoPl::setDoDnia()
     *
     * @param string[] $numer
     * @param string   $odDnia
     * @param string   $doDnia
    ...
    public static function validateNumerForArrayConstraintsFromSetNumer(array $values = [])
    {
        $message       = '';
        $invalidValues = [];
        foreach ($values as $sprawdzPrzesylkiOdDoPlNumerItem) {
            // validation for constraint: itemType
            if (!is_string($sprawdzPrzesylkiOdDoPlNumerItem)) {
                $invalidValues[] = is_object($sprawdzPrzesylkiOdDoPlNumerItem) ? get_class($sprawdzPrzesylkiOdDoPlNumerItem) : sprintf('%s(%s)', gettype($sprawdzPrzesylkiOdDoPlNumerItem), var_export($sprawdzPrzesylkiOdDoPlNumerItem, true));
            }
        }
     ...
     *
     * @return \Mrcnpdlk\Api\PocztaTracking\Sdk\StructType\SprawdzPrzesylkiOdDoPl
     */
